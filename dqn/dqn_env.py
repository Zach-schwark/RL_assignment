...
class Gym2OpEnv(gym.Env):
    ...
    def setup_observations(self):
        ...
        #self._gym_env.observation_space = BoxGymObsSpace(self._g2op_env.observation_space, attr_to_keep = self.attr_to_keep)
        self._gym_env.observation_space = self._gym_env.observation_space.keep_only_attr(self.attr_to_keep)
